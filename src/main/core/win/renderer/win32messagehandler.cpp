...
bool Win32MessageHandler::init(HINSTANCE hinst, int nCmdShow, const uint32_t& windowWidth, const uint32_t& windowHeight)
{
  const WCHAR className[100] = L"Desktop Capture Engine MainWindow Class";
